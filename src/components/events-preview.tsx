...
const featuredEvents = [
  ...
  { id: 6, title: "Festival de Cine Independiente", description: "Cortometrajes y documentales exclusivos", date: "23 Abril", location: "Cinemateca Nacional", attendees: 600, price: 18, image: "/cinema-festival.jpg", category: "Cultura", rating: 4.7 },
  { id: 7, title: "Arte y Cultura Urbana", description: "Expresiones artísticas callejeras", date: "27 Abril", location: "Distrito Creativo", attendees: 1500, price: 10, image: "/images/img11.jpg?height=200&width=300", category: "Arte", rating: 4.8 },
  { id: 8, title: "Feria de Artesanías", description: "Lo mejor del arte tradicional local", date: "29 Abril", location: "Plaza Central", attendees: 2000, price: 5, image: "/handicrafts-fair.jpg", category: "Cultura", rating: 4.5 },
  { id: 15, title: "Teatro Contemporáneo", description: "Obras vanguardistas de dramaturgos locales", date: "3 Mayo", location: "Teatro Municipal", attendees: 450, price: 30, image: "/contemporary-theater-drama-performance-stage.jpg", category: "Cultura", rating: 4.8 },
  { id: 16, title: "Noche de Poesía", description: "Recitales y spoken word de poetas emergentes", date: "5 Mayo", location: "Café Literario", attendees: 200, price: 12, image: "/poetry-night-spoken-word-literature-event.jpg", category: "Cultura", rating: 4.6 },
