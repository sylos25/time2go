    ...
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="h-8 w-1.5 rounded-full bg-teal-600 flex-shrink-0" />
          <div>
            <h3 className="text-3xl lg:text-4xl font-extrabold tracking-tight bg-green-600 bg-clip-text text-transparent">
              {title}
            </h3>
